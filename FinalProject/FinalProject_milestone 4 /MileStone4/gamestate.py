...
class GameState():
    ...
    def _list_valid_red_moves(self):
        '''
        Return:
    ...
    def dicExistValidMove(self):
        ...
        '''
        dic_valid_moves = {}
        dic = self._list_valid_red_moves()
    ...
    def dicExistSkipped(self):
        '''
        Return:
            Dictonary of valid moves that have skipped moves.
        '''
        dic_valid_skipped = {}
        dic = self._list_valid_red_moves()
        for key, value in dic.items():
    ...
    def ai_move(self):
        ...
        # print(dic_can_skipped,"dic_can_skipped")
        dic_can_move = self.dicExistValidMove()
        # print(dic_can_move,"dic_can_move")
